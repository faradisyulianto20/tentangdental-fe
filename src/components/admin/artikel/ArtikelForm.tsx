  ...
  return (
    <FieldSet className="" data-testid="artikel-form">
      <Field className="grid w-full items-center gap-4">
        ...
        <FileUpload 
          label={<span>Unggah Gambar <span className="text-red-500">*</span></span>}
      ...
      <Field className="grid w-full items-center gap-4">
        <FieldLabel htmlFor="artikel-penulis">Penulis <span className="text-red-500">*</span></FieldLabel>
        <Input 
          id="artikel-penulis" 
      ...
      <Field orientation="horizontal">
        <Button type="submit" data-testid="artikel-submit-button">Tambahkan Artikel</Button>
      </Field>
    </FieldSet>
  )
}