...
export const appEnv = {
  ...
  apiBaseUrl: import.meta.env.VITE_API_BASE_URL || 'https://tentang-dental-be-production.up.railway.app/api',
  storageBaseUrl:
    import.meta.env.VITE_STORAGE_BASE_URL || 'https://tentang-dental-be-production.up.railway.app/storage',
