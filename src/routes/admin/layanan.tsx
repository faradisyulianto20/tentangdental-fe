    ...
    <div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6'>
        {layananList.map((layanan, index) => (
          <div key={index} onClick={() => setSelectedLayanan(layanan)} className="cursor-pointer">
          ...
          <form className="space-y-4">
            <FieldGroup>
                ...
                <FieldGroup>
                  <Field>
                    ...
                    <Input
                      ...
                      defaultValue={selectedLayanan?.title}
                    />
                  </Field>
                  <Field>
                    ...
                    <Input
                      ...
                      defaultValue={selectedLayanan?.subTitle}
                    />
                  </Field>
                  <Field>
              ...
              <DialogFooter className="gap-2">
                ...
                <Button type="button" className='bg-red-400 hover:bg-red-500'>Hapus Layanan</Button>
